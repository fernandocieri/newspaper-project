...
const mockedNews = [{
  ...
  images: ['https://i.blogs.es/047ca0/azure_ampule_release_print/1366_2000.jpeg', 'https://i.blogs.es/9cc3d4/49004_post_sequence_test/1366_2000.jpg'],
  author: 'CARLOS PREGO',
  comments: 15,
  publishedTime: 14,
  idNumber: 24
},
{
  ...
  images: ['https://i.blogs.es/2ab458/captura-de-pantalla-2021-12-07-a-las-11.09.06/500_333.jpeg', 'https://i.blogs.es/31aed1/euro-redisenyo-2/1366_2000.jpeg'],
...
{
  artTitle: 'Sony prepara nuevas micropantallas 4K OLED para una realidad virtual 8K más inmersiva que nunca',
  artTheme: 'tecnología',
  artDescription: 'El objetivo, parece, no es tanto el gaming como aprovecharlas en entornos industriales.',
  ...
  images: ['https://i.blogs.es/635826/vr1/1366_2000.jpeg', 'https://tec.mx/sites/default/files/styles/header_full/public/2020-09/La-realidad-aumentada-sera-anadida-al-metodo-de-ensenanza-actual.jpg?h=920929c4&itok=rY5SW9HA'],
  author: 'JAVIER PASTOR',
  comments: 5,
  publishedTime: 3,
  idNumber: 69
...
{
  artTitle: 'Los reactores de fisión nuclear tienen una aliada que los ayudará a seguir evolucionando: la aleación 617',
  artTheme: 'ciencia',
  artDescription: 'La esperanza de las centrales nucleares de cuarta generación está depositada sobre este innovador material. Esta minuciosa combinación de cromo, cobalto, níquel y molibdeno puede contribuir a que estén preparadas en menos tiempo. ',
  ...
  images: ['https://i.blogs.es/b05412/reactornuclear-ap/1366_2000.jpg', 'https://i.blogs.es/f0ee8e/vasijanuclear/1366_2000.jpg'],
...
{
  artTitle: 'EE.UU. afronta una nueva polémica sobre privacidad y el protagonista es Clearview AI, el software de reconocimiento facial',
  artTheme: 'tecnología',
  artDescription: 'EE.UU. afronta un nuevo capítulo en el debate entre privacidad y seguridad. La protagonista es en esta ocasión Clearview y su polémico software de reconocimiento facial. Pese a las voces crítiacs, la firma ha logrado una patente federal. ',
  ...
  images: ['https://i.blogs.es/5faa43/1366_2000-3-/500_333.jpg', 'https://i.blogs.es/338374/1366_2000-4-/1366_2000.jpg'],
  author: 'CARLOS PREGO',
  comments: 4,
  publishedTime: 8,
  idNumber: 123
...
{
  artTitle: 'He hecho caso a los consejos de inversión de Forocoches durante el último año (y todavía he ganado un 12%)',
  artTheme: 'economía',
  artDescription: 'Pole.',
  ...
  images: ['https://i.blogs.es/37b471/1366_2000-2/500_333.jpg', 'https://i.blogs.es/2787c8/inversiones-forococheras.001/1366_2000.png'],
...
{
  artTitle: 'Volvo quiere que todo tu parabrisas sea un gigantesco HUD en el que se proyecte información mientras conduces',
  artTheme: 'tecnología',
...
class Main extends React.Component {
  constructor(props) {
    super(props)
    this.state = { news: [...mockedNews], openFullArticle: false, showedArtID: undefined, articleTheme: undefined };
  ...
  render() {
    ...
    const explorePage = (
      <section className='explore'>
        {this.state.news.map(article => <NewsArticlePreview newsData={article} handlePageChanges={this.handlePageChanges} key={article.idNumber} /*key={mockedNews.indexOf(article)}*/ />)}
      </section>
    )

    let filteredThemes = (
      <>
        {this.state.news.map(theme => <Header handleFilterThemes={this.handleFilterThemes} newsData={theme} />)}
      </>
    )
...
class Header extends React.Component {
  ...
  render() {
    return (
      <header>
        <nav>
          <button onClick={this.sendTheme}>{this.state.artTheme}</button>
        </nav>
      </header>
    )
  }
