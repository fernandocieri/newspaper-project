...
class NewsArticlePreview extends React.Component {
  ...
  //   if(prevProps.articleTheme !== this.props.articleTheme) {
  //     this.forceUpdate()
  //     console.log(`Estado PREVIO ${prevProps.articleTheme}`)
  //     console.log(`Estado nuevo ${this.props.articleTheme}`)
  //   }
  // }  

  // componentDidUpdate(prevProps){
  //   if(prevProps.artTheme !== this.props.articleTheme){
  //     this.setState({...this.props.newsData, articleTheme: this.props.articleTheme})
  //   }
  // }
  render() {    
    return (
...
class Main extends React.Component {
  ...
  render() {    
    ...
    /*when {articleIsOpen == true} or filteredExplorePage will hide and articlePage will display, 
